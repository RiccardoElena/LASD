...
void EqualLinear(uint &testnum, uint &testerr,
...
template <typename Data>
void NonEqualLinear(uint &testnum, uint &testerr,
                    const lasd::LinearContainer<Data> &con1,
                    const lasd::LinearContainer<Data> &con2, bool chk) {
  bool tst;
  testnum++;
...
template <typename Data>
void GetAt(uint &testnum, uint &testerr, const lasd::LinearContainer<Data> &con,
...
template <typename Data>
void SetAt(uint &testnum, uint &testerr, lasd::LinearContainer<Data> &con,
           bool chk, const unsigned long &ind, const Data &val) {
  bool tst;
  testnum++;
  try {
...
template <typename Data>
void GetFront(uint &testnum, uint &testerr,
...
template <typename Data>
void SetFront(uint &testnum, uint &testerr, lasd::LinearContainer<Data> &con,
...
template <typename Data>
void GetBack(uint &testnum, uint &testerr,
             const lasd::LinearContainer<Data> &con, bool chk,
             const Data &val) {
  bool tst;
  testnum++;
...
template <typename Data>
void SetBack(uint &testnum, uint &testerr, lasd::LinearContainer<Data> &con,
             bool chk, const Data &val) {
  bool tst;
  testnum++;
  try {
