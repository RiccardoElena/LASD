...
void Fold(unsigned int &testnum, unsigned int &testerr, const lasd::TraversableContainer<Data> &con, bool chk, typename lasd::TraversableContainer<Data>::template FoldFun<Value> fun, const Value &inival, const Value &finval) // TODO: Test on linux without template
{
  bool tst;
  testnum++;
  try
...
template <typename Data, typename Value>
void FoldPreOrder(unsigned int &testnum, unsigned int &testerr, const lasd::PreOrderTraversableContainer<Data> &con, bool chk, typename lasd::TraversableContainer<Data>::template FoldFun<Value> fun, const Value &inival, const Value &finval)
{
  bool tst;
  testnum++;
  try
