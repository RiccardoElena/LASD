...
void stestVectorInt(uint &testnum, uint &testerr) {
  ...
  try {
    ...
    }
    {
      ...
      FoldPostOrder(loctestnum, loctesterr, vec, true, &FoldMultiply<int>, 1,
                    60);
...
void stestVectorDouble(uint &testnum, uint &testerr) {
  ...
  try {
    ...
    FoldPostOrder(loctestnum, loctesterr, vec, true, &FoldMultiply<double>, 1.0,
                  19.965);
  } catch (...) {
    loctestnum++;
    loctesterr++;
  ...
  cout << "End of Vector<double> Test! (Errors/Tests: " << loctesterr << "/"
       << loctestnum << ")" << endl;
  testnum += loctestnum;
  testerr += loctesterr;
}
...
void stestVectorString(uint &testnum, uint &testerr) {
  ...
  try {
    ...
    MapPreOrder(loctestnum, loctesterr, vec, true,
    ...
    FoldPostOrder(loctestnum, loctesterr, vec, true, &FoldStringConcatenate,
  ...
  cout << "End of Vector<string> Test! (Errors/Tests: " << loctesterr << "/"
       << loctestnum << ")" << endl;
  testnum += loctestnum;
  testerr += loctesterr;
}
...
void stestVector(uint &testnum, uint &testerr) {
  ...
  testerr += loctesterr;
  cout << endl
       << "Exercise 1A - Vector (Errors/Tests: " << loctesterr << "/"
       << loctestnum << ")" << endl;
}
...
//     &TraversePrint<int>); FoldPreOrder(loctestnum, loctesterr, lst, true,
//     &FoldAdd<int>, 0, 0); FoldPostOrder(loctestnum, loctesterr, lst, true,
//     &FoldAdd<int>, 0, 0);
...
//     TraversePostOrder(loctestnum, loctesterr, lst, true,
//     &TraversePrint<int>); FoldPreOrder(loctestnum, loctesterr, lst, true,
//     &FoldAdd<int>, 0, 25); FoldPostOrder(loctestnum, loctesterr, lst, true,
//     &FoldMultiply<int>, 1, 1620);
...
//   loctestnum << ")" << endl; testnum += loctestnum; testerr += loctesterr;
// }
...
//     TraversePreOrder(loctestnum, loctesterr, lst, true,
//     &TraversePrint<double>); TraversePostOrder(loctestnum, loctesterr, lst,
//     true, &TraversePrint<double>); FoldPreOrder(loctestnum, loctesterr, lst,
//     true, &FoldAdd<double>, 0.0, 10.4); FoldPostOrder(loctestnum, loctesterr,
//     lst, true, &FoldMultiply<double>, 1.0, 9.9825);
//   }
//   catch (...) {
//     loctestnum++; loctesterr++;
//     cout << endl << "Unmanaged error! " << endl;
...
//     MapStringAppend(str, string(" ")); }); TraversePreOrder(loctestnum,
//     loctesterr, lst, true, &TraversePrint<string>); FoldPreOrder(loctestnum,
//     loctesterr, lst, true, &FoldStringConcatenate, string("X"), string("XA B
//     ")); FoldPostOrder(loctestnum, loctesterr, lst, true,
//     &FoldStringConcatenate, string("X"), string("XB A "));
...
//     coplst = move(lst);
//     FoldPreOrder(loctestnum, loctesterr, coplst, true,
//     &FoldStringConcatenate, string("?"), string("?CB A"));
//   }
//   catch (...) {
//     loctestnum++; loctesterr++;
//     cout << endl << "Unmanaged error! " << endl;
...
//   testnum += loctestnum;
//   testerr += loctesterr;
//   cout << endl << "Exercise 1A - List (Errors/Tests: " << loctesterr << "/"
//   << loctestnum << ")" << endl;
// }
...
//     cout << endl << "Unmanaged error! " << endl;
//   }
//   cout << "End of Vector/List<int> Test! (Errors/Tests: " << loctesterr <<
//   "/" << loctestnum << ")" << endl; testnum += loctestnum; testerr +=
//   loctesterr;
// }
...
//   testnum += loctestnum;
//   testerr += loctesterr;
//   cout << endl << "Exercise 1A - Vector/List (Errors/Tests: " << loctesterr
//   << "/" << loctestnum << ")" << endl;
// }
...
void testSimpleExercise1A(uint &testnum, uint &testerr) {
  ...
  cout << endl
       << "Exercise 1A (Simple Test) (Errors/Tests: " << testerr << "/"
       << testnum << ")" << endl;
}
